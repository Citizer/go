...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            this.dataGridView1.Columns.Add("Emp ID", "Emp ID");

            this.dataGridView1.Columns.Add("F Name", " F Name");

            this.dataGridView1.Columns.Add("L Name", "L Name");
        ...
        private void dataGridView1_Paint(object sender, PaintEventArgs e)
        {
            ...
            for (int j = 0; j < 2; )
            {
                ...
                Rectangle r1 = this.dataGridView1.GetCellDisplayRectangle(1, -1, true);
                ...
                e.Graphics.DrawString(cell[j / 2],
